...
The following pie chart shows a comparison between the amount of overall sales of games that are released on multiple platforms. The pie chart is split into different slices resembling sales on each platform the game is sold. This chart is included to clearly show the sales among platforms for specific games to clear inquiry regarding the many inputs of a certain game. Below is a pie chart using the game Grand Theft Auto V as an example:
