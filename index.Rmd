...
One piece of information we were interested to look further into was what publishers were dominant in various regions as well as which publishers were dominant worldwide. In North America, the top 3 publishers in 2016 were `r na_publisher`. Next, in Europe, the top 3 publishers were `r eu_publisher`. Last, in Japan the top 3 publishers were `r jp_publisher`. Overall, the top 3 publishers globally were `r global_publisher`. Overall, it was interesting to see that Nintendo was one of the top publishers across the board.

### What are the top 3 game genres in a given region based on sales?
From our second question, we looked to find which genres were most popular in certain regions depending on the sales of various games. In North America, the top 3 genres were `r na_genres`. In Japan, the top 3 genres were `r jp_genres`. In Europe, the top 3 genres were `r eu_genres`. Lastly, the top 3 genres worldwide, were `r global_genres`. From this, we found that Action, Sports, and shooter games were prodominantly popular with one outlier being Role-Playing games in Japan.
...
The following barcharts look at different genre's to see which games and publishers sold the most globally. These barcharts looked at genre and global sales exceeding 3 standard deviation from the mean global sales in order to focus on the top performing games. This barchart is included becuase it is clear to see which games performed the most and which publisher produced the games. 
