...
The following barcharts look at different genre's to see which games and publishers sold the most globally. These barcharts looked at genre and global sales exceeding 3 standard deviation from the mean global sales in order to focus on the top performing games. This barchart is included becuase it is clear to see which games performed the most and which publisher produced the games. The useage of color to differentiate publisher's also adds to the clarity of the chart. The 3 genres that we tested were sports, shooter, and platform. For sports games, we can see that the top game sales are all from Nintendo and their Wii fit and Wii sports games. For shooter games, we can tell that Call of duty games from Activision made the most sum of money, but Duck Hunt actually beats out all of the other games by itself. For Platform games, we can see that Nintendo dominates this genre, especially with their Super Mario games.
